...
class Server(object):
    ...
    def __init__(self, env, max_concurrency, num_threads, speed, name,
        ...
        # type: (simpy.Environment, int, int, float, str, Optional[List[Tuple[str, SvcRequest]]], Optional[List[Tuple[str, SvcRequest]]]) -> None
        """Initializer.
        ...
        Args:
            ...
            hw_svc_req_log: If not None, a sequence where hardware
                ...
                pair (name, svc_req), where name is this server's name and
                svc_req is the current service request generated by this group.
    ...
    def hw_request(self, svc_req=None):
        ...
        if self.hw_svc_req_log is not None and svc_req is not None:
            self.hw_svc_req_log.append((self.name, svc_req))
    ...
    def thread_request(self, svc_req=None):
        ...
        if self.sw_svc_req_log is not None and svc_req is not None:
            self.sw_svc_req_log.append((self.name, svc_req))
